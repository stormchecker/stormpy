...
std::shared_ptr<storm::modelchecker::CheckResult> checkRationalIntervalDtmc(std::shared_ptr<storm::models::sparse::Dtmc<storm::RationalInterval>> dtmc,
                                                                            CheckTask<storm::RationalNumber> const& task, storm::Environment& env) {
...
std::shared_ptr<storm::modelchecker::CheckResult> checkRationalIntervalMdp(std::shared_ptr<storm::models::sparse::Mdp<storm::RationalInterval>> mdp,
                                                                           CheckTask<storm::RationalNumber> const& task, storm::Environment& env) {
