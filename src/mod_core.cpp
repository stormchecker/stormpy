...
PYBIND11_MODULE(_core, m) {
    ...
    define_typed_result<storm::RationalNumber>(m);
    define_typed_result<storm::RationalFunction>(m);
    ...
    define_transformation_typed<double>(m);
    define_transformation_typed<storm::RationalNumber>(m);
    define_transformation_typed<storm::RationalFunction>(m);
    define_transformation_typed<storm::Interval>(m);
    define_transformation_typed<storm::RationalInterval>(m);
    define_transformation_typed_only_numbers<double>(m);
    define_transformation_typed_only_numbers<storm::RationalNumber>(m);
    define_sparse_model_simulator<double>(m);
    define_sparse_model_simulator<storm::RationalNumber>(m);
    define_prism_program_simulator<double>(m);
}
